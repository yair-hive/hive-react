...
export function useTagsDelete(){
    ...
    var mutation = useMutation(({tag_id}) =>{
...
export function useTagsUpdate(){
    ...
    var name_mutation = useMutation(({tag_id, name}) =>{
    ...
    var color_mutation = useMutation(({tag_id, color}) =>{
    ...
    var score_mutation = useMutation(({tag_id, score}) =>{
